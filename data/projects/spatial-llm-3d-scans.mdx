...
<div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
  <div style={{ flex: 1 }}>
    ...
    <p style={{ textAlign: 'center', fontSize: '0.9rem', marginTop: '0.5rem', fontStyle: 'italic' }}>Poission: complex furniture</p>
  </div>
  <div style={{ flex: 1 }}>
...
<video width="100%" controls style={{ marginTop: '1rem', marginBottom: '1rem' }}>
  <source src="/videos/spatial-llm/SAM23D_viewer.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
![Complete AI agent reasoning pipeline](/images/projects/spatial-llm/pipeline_diagram.png)
*Complete AI agent reasoning pipeline*

![Height histogram floor detection](/images/projects/spatial-llm/height_histogram_True.png)
*Height histogram floor detection*
