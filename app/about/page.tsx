  ...
  return (
    <div className="divide-y divide-gray-200 dark:divide-gray-700">
      <div className="space-y-2 pt-6 pb-8 md:space-y-5">
        <h1 className="text-3xl leading-9 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14 dark:text-gray-100">About</h1>
      ...
      <div className="container py-12">
        <div className="mx-auto max-w-5xl space-y-8">
          ...
          <section className="rounded-xl border border-gray-200/60 bg-white/60 p-6 ring-1 ring-gray-200/40 dark:border-gray-800/60 dark:bg-gray-900/60 dark:ring-white/10">
            ...
            <div className="mt-3 grid items-center gap-6 md:grid-cols-5">
              ...
              <div className="md:col-span-2">
                <Image src="/images/about/flow.gif" alt="Research workflow" width={600} height={400} className="w-full rounded-md object-contain" />
              </div>
            </div>
          </section>
          ...
          <section className="rounded-xl border border-gray-200/60 bg-white/60 p-6 ring-1 ring-gray-200/40 dark:border-gray-800/60 dark:bg-gray-900/60 dark:ring-white/10">
            ...
            <ul className="mt-3 space-y-3 text-gray-700 dark:text-gray-300">
              <li>
                ...
                <div className="mt-1 text-sm text-gray-500 dark:text-gray-400">Sep 2024 – Present</div>
              ...
              <li>
                ...
                <div className="mt-1 text-sm text-gray-500 dark:text-gray-400">Sep 2020 – Jun 2024</div>
                <div>School of Geography and Tourism</div>
                <div>
                  <em>BSc Geographical Sciences</em>
                </div>
              </li>
            </ul>
          </section>
            ...
            <div className="mt-4 space-y-6">
              <div>
                <div className="flex items-center gap-2 font-medium text-gray-900 dark:text-gray-100">
                  ...
                  <span>
                    <Link href="https://wufan-zhao.github.io/group/">AI4City Lab</Link>, <Link href="https://www.hkust-gz.edu.cn/">The Hong Kong University of Science and Technology-Guangzhou</Link>,
                    China · Research Assistant
                  </span>
                </div>
                <div className="mt-1 text-sm text-gray-500 dark:text-gray-400">Jul 2025 – Present</div>
              ...
              <div>
                <div className="flex items-center gap-2 font-medium text-gray-900 dark:text-gray-100">
                  ...
                  <span>
                    <Link href="https://hss.cuhk.edu.cn/en">School of Humanities and Social Science</Link>, <Link href="https://www.cuhk.edu.cn/en">The Chinese University of Hong Kong‑Shenzhen</Link>,
                    China · Research Assistant
                  </span>
                </div>
                <div className="mt-1 text-sm text-gray-500 dark:text-gray-400">Jun 2024 – Oct 2024</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <div>
                ...
                <div className="mt-1 text-sm text-gray-500 dark:text-gray-400">Sep 2023 – Nov 2023</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">
